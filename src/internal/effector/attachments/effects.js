...
import {
  attachmentsLoadingState, changingAttachmentLoadingState,
  creatingAttachmentLoadingState, lastGetAttachmentDataRequest,
  lastGetAttachmentsListRequest, loadingAttachmentDataState
} from "./store";
import AttachmentsApi from "../../../data/api/attachments/attachments_api";
...
export const changeAttachment = createEffect((payload) => {
  ...
  const {promise} = AttachmentsApi.changeItem(payload.id, AttachmentsMapper.getAttachmentToApi(payload.data))
