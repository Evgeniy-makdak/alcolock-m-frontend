...
import {
  ...
  allAlkozamkiState, changeAlcolcokLoadingState, createAlcolcokLoadingState,
  lastGetAlcolocksListRequestState, lastGetItemDataRequest, lastSearchAlcolocksRequest,
  loadingItemDataState
} from "./store";
import AlcolocksApi from "../../../data/api/alcolocks/alcolocks_api";
...
export const addItem = createEffect((data) => {
  ...
  const {promise} = AlcolocksApi.createItem(AlcolocksMapper.getAlcolockToApi(
    {
      ...data,
...
export const changeAlcolockService = createEffect((
  {
    id,
    workMode,
    serviceStatus
