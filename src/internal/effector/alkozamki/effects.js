...
export const uploadAlkozamkiList = createEffect(({ page, limit, sortBy, order, query, startDate, endDate, groupId }) => {
...
export const changeItem = createEffect((payload) => {
  ...
  const { promise } = AlcolocksApi.changeItem(payload.id, AlcolocksMapper.getAlcolockToApi(payload.data));
