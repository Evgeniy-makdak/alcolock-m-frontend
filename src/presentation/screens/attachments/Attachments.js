  ...
  return (
    <div className={'page attachments'}>
      <EditTable
        ...
        deleteItemPromise={userData?.permissions.attachments === UserPermissionsTypes.create ? deleteAttachment : null}
        addItemPromise={userData?.permissions.attachments === UserPermissionsTypes.create ? addAttachment : null}
        deletePopupParams={{
