        ...
        <Info
          ...
          fields={[
              ...
              : null,
            {
              label: 'Координаты:',
              value:
                !!(eventData?.events ?? [])[0] && !!eventData?.events[0].latitude && !!eventData?.events[0].longitude ? (
                  <MapLink latitude={eventData.events[0].latitude} longitude={eventData.events[0].longitude} />
                ) : (
                  '-'
                ),
            },
