    ...
    <div className={'event-data'}>
      {type !== HistoryTypes.byUser &&
        <div className="event-data__row">
          ...
          <span>
            {Formatters.nameFormatter((event?.events ?? [])[0]?.userRecord)}
          </span>
        </div>
      }
      ...
      {type !== HistoryTypes.byUser &&
        <div className="event-data__row">
          ...
          <span>
            {(event?.events ?? [])[0]?.userRecord?.email}
          </span>
        </div>
      }
      ...
      {type !== HistoryTypes.byCar &&
        <div className="event-data__row">
          <span>
            ...
            <span>
            {event?.vehicleRecord?.manufacturer ?? '-'}
          </span>
        </div>
      }
