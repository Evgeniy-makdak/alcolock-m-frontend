...
import { ARIA_LABAEL_TEXT } from '../lib/const';
  ...
  return (
    <div className={style.paginationActions}>
      <IconButton
        ...
        disabled={page === 0}
        aria-label={ARIA_LABAEL_TEXT.first_page}>
        {theme.direction === 'rtl' ? <LastPageIcon /> : <FirstPageIcon />}
      </IconButton>
      <IconButton
        onClick={(event) => onPageChange(event, page - 1)}
        disabled={page === 0}
        aria-label={ARIA_LABAEL_TEXT.previous_page}>
      ...
      <IconButton
        ...
        aria-label={ARIA_LABAEL_TEXT.next_page}>
      ...
      <IconButton
        ...
        disabled={page >= Math.ceil(count / rowsPerPage) - 1}
        aria-label={ARIA_LABAEL_TEXT.last_page}>
